...
| `genericSevenSeas_ln` |              `I’m the Evil Lord of an Intergalactic Empire!`               | Supports all volumes from 1 to 10             |
...
| `genericSevenSeas_ln` |            `Modern Dungeon Capture Starting with Broken Skills`            | Supports all volumes from 1 to 2              |
